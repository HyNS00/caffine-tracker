...
// Favorite API (신규)
const FavoriteAPI = {
    getAll: () => fetchAPI(`${API_BASE}/favorites`),

    add: (type, beverageId) => fetchAPI(`${API_BASE}/favorites`, {
        method: 'POST',
        body: JSON.stringify({ type, beverageId }),
    }),

    delete: (favoriteId) => fetchAPI(`${API_BASE}/favorites/${favoriteId}`, {
        method: 'DELETE',
    }),

    updateOrder: (favoriteIds) => fetchAPI(`${API_BASE}/favorites/order`, {
        method: 'PUT',
